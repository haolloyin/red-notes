...
output: [
    ...
    with red [
        exec: context [
            ...
            str200: string/load " world" 7 
            str201: string/load "Red" 4 
            stack/mark-native ~append 
            blk202: block/push* 1 
            word/push ~n 
            block/append* 
            stack/unwind 
            ctx203: _context/make blk202 yes 
            stack/mark-native ~append 
            blk204: block/push* 3 
            word/push-local ctx203 0 
            block/append* 
            stack/keep 
            word/push ~+ 
            block/append* 
            ...
            block/append* 
            stack/unwind 
            str207: string/load "0.4.0, 17-Mar-2018/23:29:04+8:00" 33 
            str208: string/load {Please specify a system refinement value (/version, /words, or /platform).} 75 
            ------------| "Declarations" 
            r1: 0 
            rlim1: 0 
            i1: 0 
            ...
            f_system: func [/local ~version ~words ~platform] [
                ...
                either logic/true? [
                    stack/reset 
                    stack/reset 
                    ------------| {"0.4.0, 17-Mar-2018/23:29:04+8:00"} 
                    string/push str207 
                    ------------| {"0.4.0, 17-Mar-2018/23:29:04+8:00"}
                ] [
                    stack/reset 
                ...
                stack/unwind 
                ------------| {case [version ["0.4.0, 17-Mar-2018/23:29:04+8:00"]...} 
                stack/unwind-last 
